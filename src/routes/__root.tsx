...
const APP_NAME = "MOZY · Private Aviation Estate";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Comunidade residencial de aviação privada na Flórida — 60 residências, pista para grandes jatos e hangar em cada casa.",
      },
